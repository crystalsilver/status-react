...
(def fake-db
  {:access-scope->commands-responses {#{:global :personal-chats :anonymous} {:command {"global-command1" ["0x1" :command 0 "global-command1"]}}
                                      #{"0x1" :personal-chats :anonymous} {:command {"command2" ["0x1" :command 2 "command2"]}}
                                      #{"0x1" :group-chats :anonymous} {:command {"command2" ["0x1" :command 4 "command2"]}} 
                                      #{"0x2" :personal-chats :anonymous} {:command {"command3" ["0x2" :command 2 "command3"]}}
                                      #{"0x2" :group-chats :anonymous} {:response {"response1" ["0x2" :response 4 "response1"]}}}
